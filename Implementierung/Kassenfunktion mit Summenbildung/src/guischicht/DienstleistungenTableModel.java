...
public class DienstleistungenTableModel extends AbstractTableModel {
	...
	public Object getValueAt(int row, int col){
		switch (col){
		case 0: return dienstleistungen[col].getVerkaufsMenge();
		case 1: return dienstleistungen[col].getVerkaufsMenge();
		case 2: return dienstleistungen[col].getVerkaufsMenge();
	...
	public void setValueAt(Object eintrag, int row, int col) {
	      ...
	      switch(col){
	        case 0 : dienstleistungen[col].setVerkaufsMenge((int)eintrag);
	        case 1 : dienstleistungen[col].setVerkaufsMenge((int)eintrag);
	        case 2 : dienstleistungen[col].setVerkaufsMenge((int)eintrag);
	        }
