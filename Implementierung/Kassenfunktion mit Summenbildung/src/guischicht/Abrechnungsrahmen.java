...
public class Abrechnungsrahmen extends JFrame {
	...
	public Abrechnungsrahmen(ArrayList<Produkt> abfüllProduktSortiment,
		...
		for(int i = 0; i < abfüllProduktSortiment.size(); i++ ){
			sum2 = sum2 + ((int)(abfüllTableModel.getValueAt(0, i))* abfüllProduktSortiment.get(i).getPreis());
			System.out.println((int)(abfüllTableModel.getValueAt(0, i)) + " und " + abfüllProduktSortiment.get(i).getPreis());
	...
	class EinkaufAbschließenHandler implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			for(int i = 0; i < abfüllProduktSortiment.size(); i++ ){
				e = new Einkaufsposition(abfüllProduktSortiment.get(i).getName(), abfüllProduktSortiment.get(i).getVerkaufsMenge());
