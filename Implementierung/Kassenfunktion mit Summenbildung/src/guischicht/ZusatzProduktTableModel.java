...
public class ZusatzProduktTableModel extends AbstractTableModel{
	...
	private static final long serialVersionUID = 1L;
		...
		public Object getValueAt(int row, int col){
			switch (col){
			case 0: return produktsortiment.get(col).getVerkaufsMenge();
			case 1: return produktsortiment.get(col).getVerkaufsMenge();
			case 2: return produktsortiment.get(col).getVerkaufsMenge();
			default: return null;
			}
		}
		...
		public void setValueAt(Object eintrag, int row, int col) {
		      ...
		      switch(col){
		        case 0 : produktsortiment.get(col).setVerkaufsMenge((int) eintrag);
		        case 1 : produktsortiment.get(col).setVerkaufsMenge((int) eintrag);
		        case 2 : produktsortiment.get(col).setVerkaufsMenge((int) eintrag);
		        }
