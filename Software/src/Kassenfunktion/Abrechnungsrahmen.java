...
public class Abrechnungsrahmen extends JFrame {
	...
	public Abrechnungsrahmen(ArrayList<Produkt> abfüllProduktSortiment,
		...
		for (int i = 0; i < Dienstleistung.listeDienstleistungen.length; i++) {
			sum1 = sum1
					+ ((int) (dienstTableModel.getValueAt(0, i)) * Dienstleistung.listeDienstleistungen[i]
							.getPreisProLiter());
			System.out.println((int) (dienstTableModel.getValueAt(0, i))
					+ " und "
		...
		for (int i = 0; i < abfüllProduktSortiment.size(); i++) {
			sum2 = sum2
					+ ((int) (abfüllTableModel.getValueAt(0, i)) * abfüllProduktSortiment
							.get(i).getPreis());
			System.out.println((int) (abfüllTableModel.getValueAt(0, i))
		...
		for (int i = 0; i < zusatzProduktSortiment.size(); i++) {
			sum3 = sum3
					+ ((int) (zusatzTableModel.getValueAt(0, i)) * zusatzProduktSortiment
							.get(i).getPreis());
			System.out.println((int) (zusatzTableModel.getValueAt(0, i))
