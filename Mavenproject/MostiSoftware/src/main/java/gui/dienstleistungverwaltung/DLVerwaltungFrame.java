...
public class DLVerwaltungFrame extends JFrame {
	...
	public DLVerwaltungFrame(DLSortiment d) {
		...
		dlSelectionModel.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		dlSelectionModel.addListSelectionListener(new ListSelectionListener() {
	...
	private void deleteDL() {
		...
		int result = JOptionPane.showConfirmDialog(this,
				"Möchten Sie die Dienstleistung \"" + d.getName()
