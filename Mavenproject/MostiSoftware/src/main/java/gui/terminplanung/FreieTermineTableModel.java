...
public class FreieTermineTableModel extends AbstractTableModel {
	...
	public Object getValueAt(int row, int col) {
		...
		case 2:
			return intervallListe.get(row).getEnde() + terminlogik.getZeitslot();			//Die Zeitspanne geht dann bis eine sek vor dem nächsten Termin, also ist das Ende "eins später" als notiert
		default:
			return null;
		}
	}
