...
class ProduktBearbeitenFrame extends JDialog {
	...
	ProduktBearbeitenFrame(JFrame parent, Produkt p) {
		...
		cBoxIsAbfuellmaterial.setFont(cBoxIsAbfuellmaterial.getFont()
				.deriveFont(16f));
	...
	private class MyOkHandler implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			try {
				...
				if (produkt.isAbfüllmaterial() != cBoxIsAbfuellmaterial
						.isSelected()) {
					produkt.setAbfüllmaterial(cBoxIsAbfuellmaterial
							.isSelected());
