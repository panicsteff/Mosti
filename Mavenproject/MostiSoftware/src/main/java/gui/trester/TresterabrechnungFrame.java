...
public class TresterabrechnungFrame extends JFrame {
	...
	public TresterabrechnungFrame(int kundenId) {
		...
		lblText = new JLabel(
				"Die Literzahl für den gesamten, heutigen Tag beträgt:");
		...
		buttonGanzerTag = new JRadioButton(
				"Literzahl des gesamten, heutigen Tages");
		...
		berechneTresterpreis.setFont(berechneTresterpreis.getFont().deriveFont(
				16f));
	...
	private class MyBerechneHandler implements ActionListener {
		public void actionPerformed(ActionEvent arg0) {
			...
			lblTresterpreis
					.setText(String.valueOf(Math.round(kosten * 100) / 100.0)
							+ " €");
	...
	private class MyOkHandler implements ActionListener {
		public void actionPerformed(ActionEvent arg0) {
			...
			int result = JOptionPane.showConfirmDialog(
					TresterabrechnungFrame.this, "Der Trestergesamtpreis für "
							+ liter + " L beträgt " + Math.round(kosten * 100)
