	...
	private class MyOKHandler implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if (benutzernamePrüfen(txtBenutzername.getText()) == false) {
				JOptionPane
						.showMessageDialog(MitarbeiterHinzufügenFrame.this,
								"Benutzername ist bereits vorhanden. Bitte wählen Se einen anderen");
				return;
			}
			...
			JOptionPane.showMessageDialog(MitarbeiterHinzufügenFrame.this,
